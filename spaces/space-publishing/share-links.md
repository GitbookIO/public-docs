...
{% hint style="info" %}
This feature is available on our Business and Enterprise plans. If you'd like to learn more, check out [our plans.](../../organizations/billing/plans/#our-pricing-plans)
{% endhint %}
...
If you don't have strong privacy and security requirements, we suggest that you keep your space [public and make it unlisted](./#unlisted).
...
This process can be [automated using SSO/SAML](../../features/saml.md).

{% hint style="info" %}
**Good to know:** SSO and SAML can be used to create custom authentication for your documentation, but it will require more setup on your end. SSO and SAML are features included in the [Business plan](../../organizations/billing/plans/#business-plan).
{% endhint %}
