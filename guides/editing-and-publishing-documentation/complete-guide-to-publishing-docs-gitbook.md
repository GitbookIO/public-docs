...
The **AI & MCP** section lets you [choose the AI experience](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/ai-for-your-readers/ai-search#choose-your-sites-search-experience) you want for your end-users — you can choose none, AI search or the full AI Assistant experience. In this section you can also customize the AI Assistant experience by adding suggested questions and connecting it to third-party tools via MCP servers — allowing it to answer with extra context from those tools.
