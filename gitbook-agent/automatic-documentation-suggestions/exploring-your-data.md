...
Click the **Inspect** <picture><source srcset="../../.gitbook/assets/12_12_25_12_12_25_inspect_1.svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/12_12_25_inspect_1.svg" alt=""></picture> button on an issue to read a summary, along with GitBook Agent’s analysis of it.
...
Click **Inspect** <picture><source srcset="../../.gitbook/assets/12_12_25_12_12_25_inspect_1.svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/12_12_25_inspect_1.svg" alt=""></picture> on any topic to see the issues used to form the topic, along with a log of GitBook Agent’s thinking to process those issues and create the topic.
