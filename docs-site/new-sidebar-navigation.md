...
To learn more about organizing a site, see [Site structure](site-structure/).
...
For more detail, see [Site settings](site-settings.md) and [Site customization](customization/).
