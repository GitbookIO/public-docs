...
GitBook receives supported events from the connected platform, gathers context from your knowledge, and responds through either [GitBook Assistant](../ai-for-your-readers/gitbook-ai-assistant.md) or [GitBook Agent](overview.md).
