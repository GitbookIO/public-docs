...
{% hint style="info" %}
In addition to tools you define in the Embed config, the Assistant can also use any [MCP servers you set up](../../../ai-for-your-readers/mcp-servers-for-published-docs.md) in **Settings → AI & MCP**.
{% endhint %}
