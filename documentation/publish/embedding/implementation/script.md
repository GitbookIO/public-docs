...
If your docs [are behind auth](../../site-audience/authenticated-access/), the script must include a signed JWT token.
...
Pass when initializing with `GitBook('init', options, frameOptions)`. Used for [Adaptive Content](../../adaptive-content/) and [Authenticated Access](../../site-audience/authenticated-access/).
