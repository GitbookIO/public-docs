...
The condition editor is where you’ll set the conditions for showing or hiding a page, variant, or section. After opening the condition editor, you’ll be able to write your condition as an [expression](../../create-content/variables-and-expressions.md) that will run against data coming from visitors to your site.

<figure><img src="../../.gitbook/assets/22_01_06_condition_editor@2x (1).png" alt=""><figcaption></figcaption></figure>
...
In addition to controlling the visibility of content, you can also use claims inline using [expressions](../../create-content/variables-and-expressions.md), just like page and space variables.

To reference a claim inline using an expression, type <kbd>/</kbd> in the editor, then select <picture><source srcset="../../.gitbook/assets/25_07_23_expression_dark_mode (1).svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/25_07_23_expression (1).svg" alt=""></picture> **Expression**. Claims will be accessible in the expression editor as properties on `visitor` .
