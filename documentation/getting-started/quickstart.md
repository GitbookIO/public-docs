...
There are two ways to edit and update your content in GitBook — in our visual editor, or following a docs-as-code workflow. **You can choose one, or use a combination of both.** Whichever workflow you prefer, you'll edit your content using a **branch-based editing flow**. Find out more on [the Concepts page](../reference/concepts.md).
...
3. Follow the instructions to sync the section to your chosen Git repository. Head to the [Git Sync pages](../docs-as-code/git-sync/) to find out more.
...
{% hint style="info" %}
GitBook supports [Markdown editing](../create-content/formatting/markdown.md), so you can create and format content using common syntax.
...
You can [preview your changes](../docs-as-code/git-sync/github-pull-request-preview.md) on your published docs site from the pull request in GitHub or GitLab. Your pull request shows a status with a unique preview URL. Click **Details** on that status to open it and see how your site looks once merged.
...
Add more content to your site — an API reference, a help center, a changelog — at any time, and organize your site's navigation bar so visitors find what they're looking for. Head to [Site structure](../manage-your-site/site-structure/) to learn about sections, groups, and variants.

**Customize the look and feel**

Your site looks great out of the box — and under **Customize**, you can set your own [logo, colors, and font](../manage-your-site/customization/icons-colors-and-themes.md), adjust the layout, and update your [site's visibility](../manage-your-site/site-settings.md#audience).
{% endstep %}
...
While this may be suitable for some teams, many choose to change their URL to [a custom domain](../publish/custom-domain/) or [a custom subdirectory](../publish/custom-domain/setting-a-custom-subdirectory/).
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-cover data-type="image">Cover image</th><th data-hidden data-card-target data-type="content-ref"></th><th data-hidden data-type="image">Cover image (dark)</th><th data-hidden data-type="image">Cover image (dark)</th><th data-hidden data-type="image">Cover image (dark)</th><th data-hidden data-type="image">Cover image (dark)</th><th data-hidden data-card-cover-dark data-type="image">Cover image (dark)</th></tr></thead><tbody><tr><td><strong>Invite your team to collaborate</strong></td><td>Add team members to your organization and set permissions</td><td><a href="../.gitbook/assets/25_12_10_invite_your_team_to_collaborate_1 (1).png">25_12_10_invite_your_team_to_collaborate_1 (1).png</a></td><td><a href="../collaborate/member-management/invite-members-to-your-organization.md">invite-members-to-your-organization.md</a></td><td><a href="../.gitbook/assets/25_12_10_invite_your_team_to_collaborate (1).png">25_12_10_invite_your_team_to_collaborate (1).png</a></td><td><a href="../.gitbook/assets/25_12_10_invite_your_team_to_collaborate (1).png">25_12_10_invite_your_team_to_collaborate (1).png</a></td><td></td><td></td><td></td></tr><tr><td><strong>Change site visibility</strong></td><td>Control who can see your content with share links and authenticated access</td><td><a href="../.gitbook/assets/25_12_10_change_site_visibility_1 (1).png">25_12_10_change_site_visibility_1 (1).png</a></td><td><a href="../publish/publish-a-docs-site/#publish-a-docs-site">#publish-a-docs-site</a></td><td><a href="../.gitbook/assets/25_12_10_change_site_visibility (1).png">25_12_10_change_site_visibility (1).png</a></td><td></td><td><a href="../.gitbook/assets/25_12_10_change_site_visibility (1).png">25_12_10_change_site_visibility (1).png</a></td><td><a href="../.gitbook/assets/25_12_10_change_site_visibility (1).png">25_12_10_change_site_visibility (1).png</a></td><td></td></tr><tr><td><strong>Add auto-translations</strong></td><td>Create one-click translations that update automatically</td><td><a href="../.gitbook/assets/25_12_10_add_auto_translations_1 (1).png">25_12_10_add_auto_translations_1 (1).png</a></td><td><a href="../manage-your-site/site-settings.md">site-settings.md</a></td><td><a href="../.gitbook/assets/25_12_10_add_auto_translations (1).png">25_12_10_add_auto_translations (1).png</a></td><td></td><td></td><td><a href="../.gitbook/assets/25_12_10_add_auto_translations (1).png">25_12_10_add_auto_translations (1).png</a></td><td></td></tr><tr><td><strong>Install integrations</strong></td><td>Integrate with your stack and extend functionality with powerful integrations</td><td><a href="../.gitbook/assets/25_12_10_install_integrations_1 (1).png">25_12_10_install_integrations_1 (1).png</a></td><td><a href="/broken/pages/b29aoPwtKZKkAO7zajgr">Broken link</a></td><td><a href="../.gitbook/assets/25_12_10_install_integrations (1).png">25_12_10_install_integrations (1).png</a></td><td></td><td></td><td></td><td><a href="../.gitbook/assets/25_12_10_install_integrations (1).png">25_12_10_install_integrations (1).png</a></td></tr><tr><td><strong>Add an API reference</strong></td><td>Create auto-updating, interactive API reference docs from an API spec</td><td><a href="../.gitbook/assets/25_12_10_add_an_api_reference_1 (1).png">25_12_10_add_an_api_reference_1 (1).png</a></td><td><a href="/broken/pages/EAZLjjyX6jX76NFnj71P">Broken link</a></td><td><a href="../.gitbook/assets/25_12_10_add_an_api_reference (1).png">25_12_10_add_an_api_reference (1).png</a></td><td></td><td></td><td></td><td></td></tr><tr><td><strong>Track docs analytics</strong></td><td>Use the built-in insights to measure success and understand user behavior</td><td><a href="../.gitbook/assets/25_12_10_track_docs_analytics_1 (1).png">25_12_10_track_docs_analytics_1 (1).png</a></td><td><a href="../analytics/insights.md">insights.md</a></td><td><a href="../.gitbook/assets/25_12_10_track_docs_analytics (1).png">25_12_10_track_docs_analytics (1).png</a></td><td></td><td></td><td></td><td></td></tr></tbody></table>
