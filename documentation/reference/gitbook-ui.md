...
* **Notifications**\
  When you're tagged in a comment or conversation, or when there is important activity in a section you're working in, you get a [notification](../collaborate/notifications.md) to show you what's new.
* **Ask or search**\
  Powered by [GitBook Agent](../create-content/searching-your-content/gitbook-ai.md), ask questions in natural language, or search through the sites and content in your organization.
* **Sites list**\
...
*   **Settings**\
    [Organization settings](../account-and-billing/organization-settings.md) and [account settings](../account-and-billing/account-settings.md) share one dedicated screen. It groups settings by **Account** and **Organization**.
...
* **Styleguides**\
  View every [style guide](../manage-your-site/site-structure/) in your organization and the sites that use it.
* **Trash**\
...
*   **Content**\
    ...
    The tree is read-only. Reorganize it in the [structure editor](../manage-your-site/site-structure/). Use the search, edit, and **+** icons on the **Content** header to find, rename, and add sections.
...
You can also manage [reusable content](../create-content/reusable-content.md) and [files](../create-content/blocks/insert-files.md) for the section.
...
For example, if you're editing a [change request](../collaborate/change-requests/), you see an overview of the change request, alongside options to open the editor, view changes, and merge your change request.
...
* **Action menu**\
  Offers actions for your section. Similar to [page actions](gitbook-ui.md#the-actions-menu), available actions differ by editing mode.
* **Overview**\
...
* **Changes view**\
  This view [highlights changes](../collaborate/change-requests/#diff-mode) in a change request using diff view. Review changes before merging.
* **Preview**\
...
* **Git Sync configuration**\
  Configure GitHub and GitLab [Sync](../docs-as-code/git-sync/) for the section.
* **The Share menu**\
...
* **Change requests**\
  Create, update, and delete [change requests](../collaborate/change-requests/).
* **Section history**\
  View [version history](../create-content/version-control.md) for the section or change request.
* **The Edit button**\
  If a section is published or [live edits](../collaborate/live-edits.md) are locked, **Edit** creates a [change request](../collaborate/change-requests/).
...
{% hint style="info" %}
To change a page URL slug, open the page’s [Action menu](gitbook-ui.md#the-actions-menu) and click **Edit title & slug**.
{% endhint %}
...
The outline lists the H1 and H2 [headings](../create-content/blocks/heading.md) on the page.

The page outline also appears on your published site. Toggle it in the [Page options](gitbook-ui.md#page-options) side panel.
