...
You can open the comments panel by clicking on the **Comments** button <picture><source srcset="../.gitbook/assets/25_01_10_comment_icon_dark (1).svg" media="(prefers-color-scheme: dark)"><img src="../.gitbook/assets/25_01_10_comment_icon_light (1).svg" alt="The Comments button icon in GitBook"></picture> in the [section header](../reference/gitbook-ui.md#space-header).
