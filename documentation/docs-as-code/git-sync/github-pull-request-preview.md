...
* **Your site is behind authenticated access.** Git Sync PR previews aren’t available for sites published behind [authenticated access](../../publish/site-audience/authenticated-access/).
