...
Then use `gitbook integration dev` to run it locally and `gitbook integration publish` to ship it. See the [integrations documentation](https://app.gitbook.com/s/2SyQSbIa1iYS7z6Dx5di/integrations) for the full development workflow.
