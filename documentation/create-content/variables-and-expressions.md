...
With variables you can create reusable text that can be conditionally referenced in [expressions](formatting/inline.md#expressions) and [conditions for adaptive content](../publish/adaptive-content/adapting-your-content.md#working-with-the-condition-editor).
...
To create a new variable, click the **Library** in your Table of Contents when editing an open [change request](../collaborate/change-requests/). Then, click **Variables**.
