...
{% column %}
<figure><img src="../../.gitbook/assets/25_12_10_columns (1).png" alt="An image of GitBook icons demonstrating side by side column functionality"><figcaption></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
