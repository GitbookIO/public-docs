...
If you leave this setting unset, GitBook derives its initial value from the site-level **Open in AI providers** page action. You can manage that setting in [Extra configuration](../../manage-your-site/customization/extra-configuration.md#open-in-ai-providers).
