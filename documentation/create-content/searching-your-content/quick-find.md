...
**​**You can open the **Quick find** palette by hitting the **Quick find** <picture><source srcset="../../.gitbook/assets/25_07_16_quick_find_1 (1).svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/25_07_16_quick_find (1).svg" alt=""></picture> button at the top of the sidebar or by pressing **⌘ + K** on Mac or **Ctrl + K** on PC.
