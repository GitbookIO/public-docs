...
This setting will _not_ auto-translate your actual content, but it can help match the interface to the language you’re writing in. To learn more about translating your content, head to the [Translations](../../gitbook-agent-1/translations.md) section.
...
This option does not enable the MCP server itself. The MCP server works only when **Page actions** is enabled. To learn more, see [MCP servers for published docs](../../ai-for-your-readers/mcp-servers-for-published-docs.md).
...
Enable this option to allow visitors to [export a PDF](../../publish/pdf-export.md) of your documentation.
