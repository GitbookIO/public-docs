...
You will also see a slightly different version of the toolbar when you [open a preview URL for your site](../../collaborate/change-requests/#preview-a-change-request) from the GitBook app, allowing you to jump back into the app to add feedback or continue editing.
...
* Previewing earlier versions of your site through your [version history](../../create-content/version-control.md)
* Previewing links for proposed changes, such as in a [change request](../../collaborate/change-requests/) created in GitBook or a pull request created through [Git Sync](../../docs-as-code/git-sync/github-pull-request-preview.md)
...
<figure><img src="../../.gitbook/assets/25_10_16_gitbook_ui_preview_toolbar@2x (1).jpg" alt=""><figcaption></figcaption></figure>
