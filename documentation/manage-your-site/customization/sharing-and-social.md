...
If your site has multiple [site sections](../site-structure/site-sections.md), you can use the drop-down menu at the top of the Customization screen to switch between each section and add a custom social preview image for each one.
