...
The content on your site lives in its [sections](../../create-content/content-structure/space.md). You can add one or multiple sections. GitBook will publish each one and handle the navigation between them.
