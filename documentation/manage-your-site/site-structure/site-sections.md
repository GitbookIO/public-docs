...
{% hint style="success" %}
Removing a section unpublishes it and its variants. It doesn’t delete the content. You can still find it in [All content](../../create-content/content-structure/all-content.md).
{% endhint %}
