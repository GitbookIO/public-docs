...
<figure><img src="../.gitbook/assets/22_01_06_organization_settings@2x (1).png" alt="A GitBook screenshot showing the organization settings page"><figcaption><p>Your organization settings page.</p></figcaption></figure>
...
[GitBook AI](../create-content/searching-your-content/gitbook-ai.md)-powered search lets members ask questions about your content in natural language. You can also enable GitBook AI for published content in your site’s [customization settings](../manage-your-site/customization/).
...
{% hint style="danger" %}
**Deleting an organization is permanent.** GitBook deletes all associated data. To keep organization-owned content, [move it to another organization](../create-content/content-structure/space.md#move-a-space) first.
{% endhint %}
...
Add and remove [members](../collaborate/member-management/). You can also update each member’s [role](../collaborate/member-management/roles.md).
...
Control how change requests are reviewed and merged across your organization. Organization rules apply to every section by default. Each section can inherit, replace, or disable those rules. Learn more about [merge rules](../collaborate/merge-rules.md).
...
Check which integrations are installed for your organization. You can also [install new integrations](../manage-your-site/install-an-integration.md).
...
[Teams](../collaborate/member-management/teams.md) group organization members. You can grant access to members of a team.
...
For each domain you add, people with an email address on that domain can access the organization after they create a GitBook account. Choose their default [role](../collaborate/member-management/roles.md).
...
Click **Manage Billing** to open Stripe. There, you can manage your payment method and billing information. You can also [cancel your plan](plans/cancelling-a-plan.md). If you renew before the billing period ends, your plan continues without interruption.
...
1. Make sure the new owner is an [admin](../collaborate/member-management/roles.md) in the organization.
