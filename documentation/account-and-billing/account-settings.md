...
<figure><img src="../.gitbook/assets/22_01_06_account_settings@2x (1).png" alt="A GitBook screenshot showing the personal settings page"><figcaption><p>Your personal settings page.</p></figcaption></figure>
...
GitBook can provide you with two types of [notifications](../collaborate/notifications.md) — email notifications, and in-app notifications. From this settings screen you can decide which kinds of notifications you would like to receive when different events happen.
