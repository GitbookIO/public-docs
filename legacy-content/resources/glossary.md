...
**reusable content:** Content that is synced across multiple locations in a section. When you create [reusable content](../creating-content/reusable-content.md) you can add it to a section as many times as you need, then edit all those instances at the same time. You can view and manage a section’s reusable content from the **Library** tab, beside **Pages** at the top of the [table of contents](glossary.md#t).

### S

**section:** An area where you can organize related content. It may contain a single page or multiple pages, sub-pages and page groups. Sections belong to a docs site and appear in a tab bar at the top of your published docs, allowing users to switch between content. You can manage a site’s [sections](../docs-site/site-structure/site-sections.md) from **Site structure**, under **General** in the site sidebar.
