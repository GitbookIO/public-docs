...
To add a new tab to a tab block, hover over the edge of a tab and click the `+` button that appears. To delete a tab, open the tab’s **Options menu** <picture><source srcset="../../documentation/.gitbook/assets/25_01_10_options_dark (1).svg" media="(prefers-color-scheme: dark)"><img src="../../documentation/.gitbook/assets/25_01_10_options_light (1).svg" alt="The Options menu icon in GitBook"></picture> then select **Delete**.

### Add, change, or remove icons

To add or change an icon, open the tab’s **Options menu** <picture><source srcset="../../documentation/.gitbook/assets/25_01_10_options_dark.svg" media="(prefers-color-scheme: dark)"><img src="../../documentation/.gitbook/assets/25_01_10_options_light.svg" alt="The Options menu icon in GitBook"></picture>. Then select **Set icon** or **Change icon**, and select an icon.

To remove an icon, open the tab’s **Options menu** <picture><source srcset="../../documentation/.gitbook/assets/25_01_10_options_dark.svg" media="(prefers-color-scheme: dark)"><img src="../../documentation/.gitbook/assets/25_01_10_options_light.svg" alt="The Options menu icon in GitBook"></picture>. Then select **Remove icon**.
