...
To create a new variable, Click the **Variables** <picture><source srcset="../.gitbook/assets/17_07_25_add_variable.svg" media="(prefers-color-scheme: dark)"><img src="../.gitbook/assets/17_07_25_add_variable_1.svg" alt=""></picture> icon in the upper right corner when editing an open [change request](../collaboration/change-requests/). This will open the Variables side panel.
