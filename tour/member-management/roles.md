...
Commenters have the same read-only access as readers, but they're also able to leave comments against content and spaces (find our more about how that works in our [comments](../../getting-started/collaboration/comments-discussion.md) documentation).
