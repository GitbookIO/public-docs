...
You now start at your organization **Home**, and each site's content, structure, settings, and tools live together in one sidebar. Content in a site lives in [sections](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/docs-site/site-structure/site-sections) — what you knew as spaces, now part of their site — organized into groups when your docs grow. And the new [All content](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/creating-content/all-content) screen gives you one place to find everything in your organization, including content that isn't part of a site yet.
...
Read about [what's changed](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/docs-site/sites-first), or jump into the [quickstart](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/getting-started/quickstart) to learn more.
{% endupdate %}

{% update date="2026-07-21" tags="new-releases" %}
## **Introducing style guides**

You can now create a [style guide](https://gitbook.com/docs/creating-content/styleguide) for your docs: a dedicated space for your team’s writing rules that GitBook Agent enforces whenever it writes, edits, or reviews content.
...
Style guides are rolling out gradually in early access. [Learn more in the style guide docs](https://app.gitbook.com/s/NkEGS7hzeqa35sMXQZ4X/creating-content/styleguide).
{% endupdate %}
...
At the end of last year we added a new way to [add AI Assistant and search bars to your documentation pages](2025-product-updates) — as button variants.
