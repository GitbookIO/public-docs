...
The content on your site comes from [spaces](https://gitbook.com/docs/content-editor/editor/content-structure/what-is-a-space) in your organization. When you create a new docs site, you can create a new space, or link an existing one.
