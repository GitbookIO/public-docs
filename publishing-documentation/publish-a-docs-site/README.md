...
<figure><img src="../../.gitbook/assets/publishing-documentation-publish-docs@2x.png" alt="A GitBook screenshot showing the docs sites homepage"><figcaption><p>GitBook's docs sites homepage.</p></figcaption></figure>
