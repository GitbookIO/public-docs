...
<figure><img src="../../.gitbook/assets/10_12_25_adding_a_section@2x.png" alt="A GitBook screenshot showing a docs site&#x27;s structure"><figcaption></figcaption></figure>
...
You can change the name and slug of each of your variants by clicking the <picture><source srcset="../../.gitbook/assets/10_01_25_10_01_25_10_01_25_edit_icon_dark.svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/10_01_25_10_01_25_10_01_25_edit_icon_light.svg" alt="The Edit icon in GitBook"></picture> **Edit** button in the table row of the variant you’d like to edit. This will open a modal. Edit the field(s) you'd like to change, then click the **Save** button to save. You can also delete the variant by clicking the **Delete variant** button in the lower left.
...
To replace a variant’s linked space with a different space, first delete it by clicking its **Edit** <picture><source srcset="../../.gitbook/assets/10_01_25_10_01_25_10_01_25_edit_icon_dark.svg" media="(prefers-color-scheme: dark)"><img src="../../.gitbook/assets/10_01_25_10_01_25_10_01_25_edit_icon_light.svg" alt="The Edit icon in GitBook"></picture> button, then click the **Delete** button in the lower left of the modal. Once the variant is deleted, click the **Add variant** button to add the new space.
