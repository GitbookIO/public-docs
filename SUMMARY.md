...
* [Document an API](create-content/document-an-api/README.md)
  * [OpenAPI](create-content/document-an-api/openapi/README.md)
    * [Add an OpenAPI specification](create-content/document-an-api/openapi/add-an-openapi-specification.md)
    * [Insert API reference in your docs](create-content/document-an-api/openapi/insert-api-reference-in-your-docs.md)
    * [Guides](create-content/document-an-api/openapi/guides/README.md)
      * [OpenAPI layouts](create-content/document-an-api/openapi/guides/openapi-layouts.md)
      * [Structuring your API reference](create-content/document-an-api/openapi/guides/structuring-your-api-reference.md)
      * [Adding custom code samples](create-content/document-an-api/openapi/guides/adding-custom-code-samples.md)
      * [Managing API operations](create-content/document-an-api/openapi/guides/managing-api-operations.md)
      * [Configuring the “Test it” button](create-content/document-an-api/openapi/guides/configuring-the-test-it-button.md)
      * [Using OpenAPI proxy](create-content/document-an-api/openapi/guides/using-openapi-proxy.md)
      * [Describing enums](create-content/document-an-api/openapi/guides/describing-enums.md)
      * [Integrating with CI/CD](create-content/document-an-api/openapi/guides/support-for-ci-cd-with-api-blocks.md)
  * [Extensions reference](create-content/document-an-api/extensions-reference.md)
