...
In the section you want to sync with your GitLab repo, click **Set up** next to **Git Sync** in the [section header](../../resources/gitbook-ui/#space-header). From the provider list, click **GitLab Sync**, and click **Configure**.
